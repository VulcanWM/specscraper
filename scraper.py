...
#         for td in tds:
#             if count == 0:
#                 output[topic_name][subtopics[subtopicIndex]]['content'] = td.get_text().replace(".", ". ")
#             elif count == 1:
#                 output[topic_name][subtopics[subtopicIndex]]['opportunity'] = td.get_text().replace(".", ". ")
#             count += 1
#         subtopicIndex += 1
